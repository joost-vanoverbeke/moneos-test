...
De evaluatie heeft volgende informatie nodig: aantallen vogels per soort per maand per segment op niveau 2 en 3 (niveau 2 is som van de waterlichamen; niveau 3 heeft betrekking op het waterlichaam of de saliniteitszone) **XXX**. 
...
```{r 100-figuur-maandelijkse-totalen, fig.cap="De maandelijkse totalen van de watervogels langsheen de Zeeschelde sinds oktober 1991 tot **XXX** (exclusief zijrivieren).", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r 100-figuur-verhouding-aantallen, fig.cap="De verhouding van de totale aantallen watervogels in de waterlichamen (winter 1991-**XXX**) (winterdata okt – mrt).", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r 100-figuur-aantallen-KRWzones, fig.cap="De wintervogelaantallen in de verschillende KRW-zones (**!gemiddelde!** per winter 1991/92 – **XXX**) Merk op: de schaal langs de y-as verschilt per waterlichaam.", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r 100-figuur-aantallen-zijrivieren, fig.cap="De wintervogelaantallen in de Dijle, Rupel en Zenne (gedeelte onder getijde-invloed) (**!gemiddelde!** per winter 1991/92 – **XXX**).", fig.height=8/2.54, fig.width=18/2.54, warning=FALSE}
