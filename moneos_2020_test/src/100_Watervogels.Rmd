...
Op de __Dijle__ (Figuur \@ref(fig:100-figuur-aantallen-zijrivieren)) was de piek van vogelaantallen van korte duur. Terwijl gemiddeld in de periode 2007-2009 nog meer dan 1 200 watervogels per winter werden geteld, is het aantal de laatste drie jaar minder dan 100 per winter.
...
```{r 100-figuur-aantallen-KRWzones, fig.cap="De wintervogelaantallen in de verschillende KRW-zones (**!gemiddelde!** per winter 1991/92 – **XXX**).", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
Van een aantal algemenere soorten worden de trends in de periode 2010-**XXX** getoond in Figuur \@ref(fig:100-figuur-aantallen-abundante-soorten) en Figuur \@ref(fig:100-figuur-aantallen-visetend-en-steltlopers).
...
```{r 100-figuur-aantallen-indicatorgroepen, fig.cap="Trends in wintervogelaantallen per KRW-zone (**!gemiddelde!** per winter 2009/10 – **XXX**) opgedeeld volgens de trofische indicatorgroepen (Nbenth: benthivoren, Nherb: herbivoren, Nomn: omnivoren en Npisc: piscivoren).", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r 100-figuur-aantallen-abundante-soorten, fig.cap="Trends in het totaal aantal getelde wintervogels (okt.-mrt.) voor 4 abundante soorten in de 4 KRW-zones van de Zeeschelde+Rupel.", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
...
```{r 100-figuur-aantallen-visetend-en-steltlopers, fig.cap="Trends in het totaal aantal getelde wintervogels (okt.-mrt.) voor 2 abundante visetende (piscivore) en twee abundante steltlopers in de 4 KRW-zones van de Zeeschelde+Rupel.", fig.height=12/2.54, fig.width=18/2.54, warning=FALSE}
