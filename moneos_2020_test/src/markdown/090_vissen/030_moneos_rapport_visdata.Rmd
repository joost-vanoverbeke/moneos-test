...
pad_figuren <- maak_pad(hoodstuk, "figuren")
pad_tabellen <- maak_pad(hoodstuk, "tabellen")
...
cap_locaties_ankerkuil <- 
  paste0("De met ankerkuil bemonsterde locaties in d Zeeschelde in de period ", 
         eerste_jaar, 
         " - ", 
         laatste_jaar, 
         ".")
...
cap_overzicht_soorten <-
  paste0("Table: (\\#tab:090-tabel-overzicht-soorten)",
         "Overzicht van de vissoorten gevangen tijdens de ankerkuilcampagnes in de Zeeschelde in ",
         laatste_jaar,
         ".")
...
Het gemiddeld aantal individuen per m³ water is weergegeven in Figuur \@ref(fig:090-figuur-gemiddeld-seizoenen) en het relatief aantal gevangen individuen in Figuur \@ref(fig:090-figuur-relatief-gevangen).
