...
ankerkuil_aantal_recent <- 
  read_delim("overzicht ankerkuil 2018 aantal.csv",
             delim = ";") %>%
  rename_all(tolower) %>% 
...
ankerkuil_gewicht_recent <- 
  read_delim("overzicht ankerkuil 2018 gewicht.csv",
             delim = ";") %>%
  rename_all(tolower) %>% 
  select(datum, locatie = locatienummer, uren, volume,
         everything(),
...
ankerkuil_aantal_historisch <- 
  read_delim("ankerkuil_aantallen_2012_2017.csv",
             delim = ";")

ankerkuil_gewicht_historisch <- 
  read_delim("ankerkuil_gewicht_2012_2017.csv",
             delim = ";")
...
file_aantallen <-
  paste0("ankerkuil_aantallen_", paste(jaar_range, collapse = "_"), ".csv")

file_gewicht <-
  paste0("ankerkuil_gewicht_", paste(jaar_range, collapse = "_"), ".csv")
